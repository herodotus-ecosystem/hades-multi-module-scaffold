...
public class Constants {
	...
	public static final String WEB_CLASS_FOLDER = "WEB-INF/classes/";
	...
	public static final String CHECK_YES = "TG";
	
	public static final String CHECK_NO = "WTG";
	
	public static final String CHECK_WSH = "WSH";
	
	public static final String CHECK_DSH = "DSH";
}
