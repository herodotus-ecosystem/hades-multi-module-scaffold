...
function SecurityTools() {
    ...
    this.Base64Encrypt = function (word) {
        return Base64.encode(word);
    }

    this.Base64Decrypt = function (word) {
    ...
    this.Decrypt = function (word) {
        ...
        return this.Base64Decrypt(this.AesDecrypt(word));
    }
    ...
    this.Encrypt = function (word) {
        ...
        return this.AesEncrypt(this.Base64Encrypt(word));
    }

    this.md5 = function md5(md5str) {
